...
export const ClockInButton = () => {
  ...
  return (
    <div className="relative">
      {/* Animated layers */}
      <div className="absolute inset-0 animate-pulse-beacon opacity-30 rounded-full bg-primary" />
      <div className="absolute inset-0 animate-pulse-beacon opacity-20 rounded-full bg-primary delay-75" />
      <div className="absolute inset-0 animate-pulse-beacon opacity-10 rounded-full bg-primary delay-150" />
