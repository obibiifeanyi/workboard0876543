      ...
      <div className="space-y-2 p-4">
        ...
        <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-red-600/10 to-red-500/10 
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-red-700 text-sm md:text-base">Admin Control</h3>
        ...
        <nav className="space-y-1">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `group relative flex items-center gap-3 rounded-2xl px-3 md:px-4 py-2 md:py-3 transition-all duration-300 text-sm md:text-base
                 ${
                   isActive
            ...
            >
              ...
              <ChevronRight className="ml-auto h-4 w-4 opacity-0 -translate-x-2 transition-all duration-300 
                                     group-hover:opacity-100 group-hover:translate-x-0 hidden md:block" />
